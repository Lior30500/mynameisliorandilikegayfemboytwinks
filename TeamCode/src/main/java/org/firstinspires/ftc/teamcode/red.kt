...
class red : NextFTCOpMode() {
    ...
    val blocker_open_pos  = 0.0
    val blocker_block_pos = 0.2
    ...
    override fun onStartButtonPressed() {
        ...
        setIndicator(LED_GREEN) // default: autoAim
    ...
    private fun updateShootOnMove() {
        ...
        fwTarget = 0.0142645 * effectiveDist * effectiveDist + 1.26161 * effectiveDist + 748.88095
    ...
    private fun updateLimelightAim() {
        ...
        if (aprilTag != null) {
            ...
            telemetry.addData("Mode", "Limelight AprilTag Aim")
            telemetry.addData("Limelight", "Tag 24 not detected — holding position")
        }
        telemetry.update()
    }
